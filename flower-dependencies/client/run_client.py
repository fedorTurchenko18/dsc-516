    ...
    for strategy_str in strategies:
        ...
        while out_cond == False and reconnect_attemps < 5:
            try:
                ...
                log_file = f'{log_dir}/{backend}_{strategy_str}_client_{instance_id}_log.log'
        ...
        # save FL log to s3
        write_to_s3_bucket_response = s3_manager.write_to_s3_bucket(log_file=log_file, object_key=f'{backend}/{strategy_str}/client_{instance_id}_log.log')